import { N as NONE, c as cls, C as CLASS_CONNECTOR, b as CLASS_ENDPOINT, d as att, e as ATTRIBUTE_GROUP, f as CLASS_OVERLAY, g as ATTRIBUTE_TABINDEX, E as EVENT_ZOOM, h as SELECTOR_MANAGED_ELEMENT, i as ATTRIBUTE_NOT_DRAGGABLE, j as createFloatingAnchor, k as CLASS_ENDPOINT_FLOATING, l as EndpointRepresentation, m as SOURCE, T as TARGET, I as INTERCEPT_BEFORE_DRAG, n as INTERCEPT_BEFORE_START_DETACH, o as ATTRIBUTE_SCOPE_PREFIX, R as REDROP_POLICY_ANY, p as REDROP_POLICY_STRICT, q as REDROP_POLICY_ANY_SOURCE, r as REDROP_POLICY_ANY_TARGET, s as REDROP_POLICY_ANY_SOURCE_OR_TARGET, t as CHECK_DROP_ALLOWED, u as classList, v as EVENT_MAX_CONNECTIONS, w as IS_DETACH_ALLOWED, x as CHECK_CONDITION, y as INTERCEPT_BEFORE_DETACH, z as ABSOLUTE, B as Connection, D as Endpoint, O as Overlay, F as BLOCK, G as isArrowOverlay, H as isDiamondOverlay, J as isPlainArrowOverlay, K as ATTRIBUTE_MANAGED, L as STATIC, M as FIXED, P as isLabelOverlay, Q as isCustomOverlay, U as JsPlumbInstance, V as DotEndpoint, W as RectangleEndpoint, X as BlankEndpoint } from "./core-defb43f2.js";
import { f as fastTrim, l as log, i as isString, a as forEach, u as uuid, r as removeWithFunction, s as snapToGrid, e as extend, b as findWithFunction, w as wrap, g as getWithFunction, c as getFromSetWithFunction, d as intersects, h as isAssignableFrom, m as merge, j as each, k as getAllWithFunction, n as functionChain, o as isObject, p as fromArray, t as isFunction } from "./util-1214d169.js";
import { W as WILDCARD, F as FALSE$1, T as TRUE$1, U as UNDEFINED } from "./common-6db23379.js";
...
function _appendAtIndex(svg2, path, idx) {
  if (svg2.childNodes.length > idx) {
    svg2.insertBefore(path, svg2.childNodes[idx]);
  } else {
...
(function(PositioningStrategies2) {
  PositioningStrategies2["absolutePosition"] = "absolutePosition";
  PositioningStrategies2["transform"] = "transform";
  PositioningStrategies2["xyAttributes"] = "xyAttributes";
})(PositioningStrategies || (PositioningStrategies = {}));
var positionerSetters = /* @__PURE__ */ new Map();
...
var positionerGetters = /* @__PURE__ */ new Map();
...
var sizeSetters = /* @__PURE__ */ new Map();
...
var sizeGetters = /* @__PURE__ */ new Map();
...
var Drag = function(_Base) {
  ...
  function Drag2(el, params, manager) {
    var _this;
  ...
  _createClass(Drag2, [{
    ...
    value: function _trackScroll(e) {
      if (this._moving) {
        ...
        }, dx = _pos2.x - this._downAt.x, dy = _pos2.y - this._downAt.y, _z = this._ignoreZoom ? 1 : this.manager.getZoom();
...
var ElementDragHandler = function() {
  function ElementDragHandler2(instance, _dragSelection) {
    ...
    _defineProperty(this, "_currentDragGroupOriginalPositions", /* @__PURE__ */ new Map());
  ...
  _createClass(ElementDragHandler2, [{
    ...
    value: function onStop(params) {
      ...
      this._dragSelection.each(function(el, id, o3, s, originalPosition) {
        if (el !== params.el) {
    ...
    value: function onDrag(params) {
      ...
      this._dragSelection.updatePositions(finalPos, this.originalPosition, function(el2, id2, s, b) {
        _one(el2, b, false);
      });
    ...
    value: function onStart(params) {
      ...
      if (cont) {
        ...
        var _one = function _one2(_el, dragGroup, dragGroupMemberSpec) {
  ...
  _createClass(EndpointDragHandler2, [{
    ...
    value: function _populateTargets(canvasElement, event) {
      ...
      if (isSourceDrag) {
        ...
        targetDefs.forEach(function(targetDef) {
          var targetZones2 = _this._findTargetZones(targetDef);
    ...
    value: function _findTargetZones(dragSelector) {
      ...
      if (dragSelector.redrop === REDROP_POLICY_ANY) {
        ...
        var _t2 = this.instance.targetSelectors.map(function(s) {
          return s.selector;
        });
        _t2.push.apply(_t2, _toConsumableArray(this.instance.sourceSelectors.map(function(s) {
          return s.selector;
        })));
        targetZonesSelector = _t2.join(",");
      }
...
function getConnectorElement(instance, c) {
  if (c.canvas != null) {
    ...
    if (c.cssClass != null) {
      instance.addClass(svg2, c.cssClass);
    }
    instance.addClass(svg2, instance.connectorClass);
    svg2.jtk = svg2.jtk || {};
    svg2.jtk.connector = c;
    return svg2;
  }
}
...
var BrowserJsPlumbInstance = function(_JsPlumbInstance) {
  ...
  _createClass(BrowserJsPlumbInstance2, [{
    ...
    value: function getOffset(el) {
      ...
      var out = this.getPosition(jel), op = el !== container && jel.offsetParent !== container ? jel.offsetParent : null, _maybeAdjustScroll = function _maybeAdjustScroll2(offsetParent) {
    ...
    value: function manage(element, internalId, _recalc) {
      ...
      var managedElement = _get(_getPrototypeOf(BrowserJsPlumbInstance2.prototype), "manage", this).call(this, element, internalId, _recalc);
...
export {
  EVENT_CONNECTION_MOUSEOUT as E,
  EVENT_CONNECTION_MOUSEOVER as a,
  EVENT_ENDPOINT_MOUSEOVER as b,
  createElement as c,
  EVENT_ENDPOINT_MOUSEOUT as d,
  EVENT_ENDPOINT_CLICK as e,
  EVENT_CONNECTION_ABORT as f,
  EVENT_DRAG_MOVE as g,
  EVENT_CONNECTION_DRAG as h,
  ready as i,
  newInstance as n,
  registerEndpointRenderer as r,
  svg as s
};
