import { l as log, q as quadrant, x as gradient, y as pointOnLine, z as lineLength, i as isString, u as uuid, E as EventGenerator, t as isFunction, e as extend, m as merge, A as setToArray, B as populate, C as clone, D as map, F as isNumber, o as isObject, h as isAssignableFrom, g as getWithFunction, r as removeWithFunction, G as suggest, a as forEach, H as insertSorted, b as findWithFunction, I as getsert, J as rotatePoint, K as filterList, n as functionChain, L as addToDictionary, T as TWO_PI, M as theta, N as normal, O as perpendicularLineTo } from "./util-1214d169.js";
import { E as EMPTY_BOUNDS, A as AbstractSegment, a as AnchorLocations, P as PerimeterAnchorShapes, D as DEFAULT, W as WILDCARD } from "./common-6db23379.js";
...
function _splitType(t) {
  return t == null ? null : t.split(" ").filter(function(t2) {
...
var Component = function(_EventGenerator) {
  ...
  function Component2(instance, params) {
    ...
    _this._types = /* @__PURE__ */ new Set();
    _this._typeCache = {};
    _this.parameters = clone(params.parameters || {});
    _this.id = params.id || _this.getIdPrefix() + (/* @__PURE__ */ new Date()).getTime();
    _this._defaultType = {
...
var LightweightFloatingAnchor = function() {
  function LightweightFloatingAnchor2(instance, element, elementId) {
...
export {
  EVENT_CONNECTION as $,
  AbstractConnector as A,
  Connection as B,
  CLASS_CONNECTOR as C,
  Endpoint as D,
  EVENT_ZOOM as E,
  BLOCK as F,
  isArrowOverlay as G,
  isDiamondOverlay as H,
  INTERCEPT_BEFORE_DRAG as I,
  isPlainArrowOverlay as J,
  ATTRIBUTE_MANAGED as K,
  STATIC as L,
  FIXED as M,
  NONE as N,
  Overlay as O,
  isLabelOverlay as P,
  isCustomOverlay as Q,
  REDROP_POLICY_ANY as R,
  StraightSegment as S,
  TARGET as T,
  JsPlumbInstance as U,
  DotEndpoint as V,
  RectangleEndpoint as W,
  BlankEndpoint as X,
  Connectors as Y,
  EndpointFactory as Z,
  INTERCEPT_BEFORE_DROP as _,
  ArcSegment as a,
  EVENT_CONNECTION_MOVED as a0,
  EVENT_CONNECTION_DETACHED as a1,
  CLASS_ENDPOINT as b,
  cls as c,
  att as d,
  ATTRIBUTE_GROUP as e,
  CLASS_OVERLAY as f,
  ATTRIBUTE_TABINDEX as g,
  SELECTOR_MANAGED_ELEMENT as h,
  ATTRIBUTE_NOT_DRAGGABLE as i,
  createFloatingAnchor as j,
  CLASS_ENDPOINT_FLOATING as k,
  EndpointRepresentation as l,
  SOURCE as m,
  INTERCEPT_BEFORE_START_DETACH as n,
  ATTRIBUTE_SCOPE_PREFIX as o,
  REDROP_POLICY_STRICT as p,
  REDROP_POLICY_ANY_SOURCE as q,
  REDROP_POLICY_ANY_TARGET as r,
  REDROP_POLICY_ANY_SOURCE_OR_TARGET as s,
  CHECK_DROP_ALLOWED as t,
  classList as u,
  EVENT_MAX_CONNECTIONS as v,
  IS_DETACH_ALLOWED as w,
  CHECK_CONDITION as x,
  INTERCEPT_BEFORE_DETACH as y,
  ABSOLUTE as z
};
