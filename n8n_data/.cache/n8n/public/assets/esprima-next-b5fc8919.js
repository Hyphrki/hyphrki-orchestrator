...
var JSXSyntax;
(function(JSXSyntax2) {
  JSXSyntax2["JSXAttribute"] = "JSXAttribute";
  JSXSyntax2["JSXClosingElement"] = "JSXClosingElement";
  JSXSyntax2["JSXClosingFragment"] = "JSXClosingFragment";
  JSXSyntax2["JSXElement"] = "JSXElement";
  JSXSyntax2["JSXEmptyExpression"] = "JSXEmptyExpression";
  JSXSyntax2["JSXExpressionContainer"] = "JSXExpressionContainer";
  JSXSyntax2["JSXIdentifier"] = "JSXIdentifier";
  JSXSyntax2["JSXMemberExpression"] = "JSXMemberExpression";
  JSXSyntax2["JSXNamespacedName"] = "JSXNamespacedName";
  JSXSyntax2["JSXOpeningElement"] = "JSXOpeningElement";
  JSXSyntax2["JSXOpeningFragment"] = "JSXOpeningFragment";
  JSXSyntax2["JSXSpreadAttribute"] = "JSXSpreadAttribute";
  JSXSyntax2["JSXText"] = "JSXText";
})(JSXSyntax || (JSXSyntax = {}));
...
class Parser {
  ...
  parseReturnStatement() {
    ...
    const hasArgument = !this.match(";") && !this.match("}") && !this.hasLineTerminator && this.lookahead.type !== 2 || this.lookahead.type === 8 || this.lookahead.type === 10;
    ...
    if (this.match("*")) {
      ...
      if (token.type === 3 && !this.hasLineTerminator && token.value === "async") {
        ...
        if (punctuator !== ":" && punctuator !== "(") {
          ...
          if (token.type === 3 && token.value === "constructor" && !isStatic) {
            this.tolerateUnexpectedToken(token, Messages.ConstructorIsAsync);
          }
        }
      }
    }
    if (token.type === 3 && token.value === "constructor" && isPrivate) {
