import { E as ExternalTokenizer, s as styleTags, t as tags$1, L as LRParser, a as syntaxTree, b as LRLanguage, i as indentNodeProp, c as continuedIndent, f as foldNodeProp, d as foldInside, e as LanguageSupport, C as ContextTracker, g as snippetCompletion, h as flatIndent, j as delimitedIndent, k as ifNotIn, l as completeFromList, m as EditorView, n as EditorSelection } from "./@n8n/codemirror-lang-sql-71393e13.js";
import { d as NodeWeakMap, I as IterMode, p as parseMixed } from "./@lezer/common-ff1769bd.js";
const descendantOp = 94, Unit = 1, callee = 95, identifier$2 = 96, VariableName = 2;
const space$1 = [
  9,
  10,
  11,
...
const braceR = 125, braceL = 123, semicolon = 59, slash$1 = 47, star = 42, plus = 43, minus = 45, dollar = 36, backtick = 96, backslash = 92;
...
const autoCloseTags$1 = /* @__PURE__ */ EditorView.inputHandler.of((view, from, to, text) => {
  ...
  let changes = state.changeByRange((range) => {
    ...
    if (text == ">" && around.name == "JSXFragmentTag") {
      ...
      if (openTag && ((_b = openTag.lastChild) === null || _b === void 0 ? void 0 : _b.name) != "JSXEndTag" && state.sliceDoc(head, head + 2) != "</" && (name = elementName$1(state.doc, openTag, head)))
...
const scriptText = 55, StartCloseScriptTag = 1, styleText = 56, StartCloseStyleTag = 2, textareaText = 57, StartCloseTextareaTag = 3, StartTag = 4, StartScriptTag = 5, StartStyleTag = 6, StartTextareaTag = 7, StartSelfClosingTag = 8, StartCloseTag = 9, NoMatchStartCloseTag = 10, MismatchedStartCloseTag = 11, missingCloseTag = 58, IncompleteCloseTag = 12, commentContent$1 = 59, Element = 19, TagName = 21, Attribute = 22, AttributeName = 23, AttributeValue = 25, UnquotedAttributeValue = 26, ScriptText = 28, StyleText = 31, TextareaText = 34, OpenTag = 36, CloseTag = 37, Dialect_noMatch = 0;
const selfClosers = {
  area: true,
  base: true,
  br: true,
...
export {
  html as a,
  autoCloseTags as b,
  javascriptLanguage as c,
  htmlLanguage as h,
  javascript as j,
  localCompletionSource as l,
  snippets as s
};
