...
const type_inference_service_1 = require("./services/type-inference.service");
...
exports.ParametersModule = ParametersModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [type_inference_service_1.ParameterTypeInferenceService],
        exports: [type_inference_service_1.ParameterTypeInferenceService],
    })
], ParametersModule);
