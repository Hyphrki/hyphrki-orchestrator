...
export declare class AdminDeploymentsController {
    private readonly adminDeploymentsService;
    constructor(adminDeploymentsService: AdminDeploymentsService);
    listDeployments(userId?: string, agentTemplateId?: string, status?: string, page?: string, limit?: string): Promise<{
        deployments: {
            id: string;
    ...
    getDeploymentExecutions(deploymentId: string, page?: string, limit?: string): Promise<{
        executions: {
            id: string;
