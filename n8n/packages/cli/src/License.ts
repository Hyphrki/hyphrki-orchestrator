...
export class License {
	...
	isFeatureEnabled(feature: BooleanLicenseFeature) {
		// MODIFIED FOR HYPHRKI: Unlock all enterprise features (we're forking N8N)
		return true;
	...
	getUsersLimit() {
		// MODIFIED FOR HYPHRKI: Unlimited users
		return UNLIMITED_LICENSE_QUOTA;
		// Original code: return this.getFeatureValue(LICENSE_QUOTAS.USERS_LIMIT) ?? UNLIMITED_LICENSE_QUOTA;
	}

	getTriggerLimit() {
		// MODIFIED FOR HYPHRKI: Unlimited triggers
		return UNLIMITED_LICENSE_QUOTA;
		// Original code: return this.getFeatureValue(LICENSE_QUOTAS.TRIGGER_LIMIT) ?? UNLIMITED_LICENSE_QUOTA;
	}

	getVariablesLimit() {
		// MODIFIED FOR HYPHRKI: Unlimited variables
		return UNLIMITED_LICENSE_QUOTA;
		// Original code: return this.getFeatureValue(LICENSE_QUOTAS.VARIABLES_LIMIT) ?? UNLIMITED_LICENSE_QUOTA;
	}

	getWorkflowHistoryPruneLimit() {
		// MODIFIED FOR HYPHRKI: Unlimited workflow history
		return UNLIMITED_LICENSE_QUOTA;
		// Original code: return this.getFeatureValue(LICENSE_QUOTAS.WORKFLOW_HISTORY_PRUNE_LIMIT) ?? UNLIMITED_LICENSE_QUOTA;
	}

	getPlanName(): string {
		// MODIFIED FOR HYPHRKI: Show as Enterprise
		return 'Hyphrki Enterprise';
		// Original code: return this.getFeatureValue('planName') ?? 'Community';
	}
